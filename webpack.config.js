...
module.exports = {
    ...
    entry: {
        main: path.resolve(__dirname, './', 'main.js'), // Arquivo que o webpack vai iniciar a ler
        gerente: path.resolve(__dirname, './', 'gerente.js'), // Arquivo que o webpack vai iniciar a ler
    },
